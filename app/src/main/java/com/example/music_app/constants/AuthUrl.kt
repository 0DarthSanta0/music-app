...
const val CODE = "code"
const val SCOPE = "user-read-private user-read-email playlist-modify-private playlist-modify-public"
...
const val AUTH_URL =
    "${BASE_URL}authorize?${ID_QUERY_PARAM}=$SPOTIFY_CLIENT_ID&$TYPE_QUERY_PARAM=$CODE&$SCOPE_QUERY_PARAM=$SCOPE&$REDIRECT_QUERY_PARAM=$REDIRECT_URL"
